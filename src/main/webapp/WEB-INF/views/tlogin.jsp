...
var naverLogin = new naver.LoginWithNaverId(
	{
		...
		callbackUrl: "http://localhost:8080/tloginWithNaver.jsp",
          ...
          success: function(authObj) {
        	  Kakao.API.request({
        		...
        		success: function(res){
        			...
        			, success : function() {
// 						alert("성공")
						location.href="/kinder/tLoginWithKakao"
					}
