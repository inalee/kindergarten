...
var countdownfunction = setInterval(function() {
 ...
 document.getElementById("demo").innerHTML = "모집 일자까지 " + days + "일 " + hours + "시간 "
 ...
 if (distance < 0) {
     ...
     document.getElementById("demo").innerHTML = "<button class='button button4' type='button'>신청하기</button>";
 }
}, 1000);
...
<h2>┃정기모집 공고 상세보기</h2>
<div id="contains">
<p style="text-align: center; margin-bottom: 40px; font-size: 30px; font-weight: bold;">■　 천사 어린이집　■</p>
...
<table class="type05">
    <tr>
        ...
        <td style="height: 90px;"><br>5명</td>
        <th style="height: 90px; background-color: #F7F8E0;" scope="row"><br>모집 일자</th>
        <td style="height: 90px; text-align: center;">2018-8-25 12:00:00<br>
        <p id="demo" style="font-size:18px" class="jg"></p></td>        
    </tr>
    <tr>
        <th scope="row">주소</th>
        <td>서울특별시 강남구 개포로 311 902동 111호(개포동, 우성9차아파트)</td>
    ...
    <tr>
        ...
        <td><a href="http://cluster1.cafe.daum.net/_c21_/home?grpid=1Rb3d">
